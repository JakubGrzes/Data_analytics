...
{" (found before start of program)",
 " (in '/root/dupa/LAB_01/code_4.stan', line 2, column 2 to column 13)",
 " (in '/root/dupa/LAB_01/code_4.stan', line 6, column 2 to column 28)"};
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    try {
      ...
      theta = in__.template read<local_scalar_t__>();
      {
        ...
        lp_accum__.add(stan::math::gamma_lpdf<propto__>(theta, 1.25, 1.25));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
